...
def ollama_chat(user_input, system_message, vault_embeddings, vault_content, ollama_model, conversation_history):
    if user_input == "":
        print(RED + "\nEmpty input received." + RESET_COLOR)
        return "It seems like your message is empty. Could you please resend it or let me know how I can assist you?"
    else:
        ...
        print(YELLOW + "Rewritten Query: " + rewritten_query + RESET_COLOR)
...
local_rag = gr.ChatInterface(
    ...
    fill_height=True, 
    fill_width=True,
    examples=["What is this document about?", "Summarize this document."],
    title="Retrieval-Augmented Generation (RAG)",
    description="<center>using ollama AI models</center>",
    )
...
local_rag.chatbot.placeholder="<center><strong>Sart chatting with your documents</strong><br>with query re-write</center>"
